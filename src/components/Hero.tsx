  ...
  return (
    ...
    >
      ...
      {/* <div className="absolute top-24 right-[45%] "> */}
        <div className="h-[200px] w-[200px] rounded-full flex items-center justify-center bg-[radial-gradient(circle,_rgb(245,247,250)_50%,_rgba(245,247,250,0)_66%)] dark:bg-[radial-gradient(circle,_rgb(0,0,0)_50%,_rgba(0,0,0,0)_66%)] animate-fadeIn">
        <img
          src="/icons/me.png"
          alt=""
      ...
      <div>
        <div className="">
          ...
          <h1 className="uppercase text-[#1A1A2E] dark:text-white xxs:text-base sm:text-3xl md:text-5xl lg:text-[72px] lg:leading-[72px] tracking-[0.36px] font-bold text-center">
            noimot alabi, a seasoned{" "}
            <span className="text-[#8E07CD]">frontend developer</span>
          </h1>
        </div>
        <p className="text-[#4A5568] dark:text-[#C2D1D6] tracking-[0.08px] leading-6 text-center max-w-[671px] mx-auto">
